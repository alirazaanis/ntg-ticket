...
export default function SLAManagementPage() {
  ...
  const [slaPolicies, setSlaPolicies] = useState([
    ...
    },
    {
      ...
      escalationLevels: [
        { level: 1, time: 4, action: 'Notify team lead' },
      ],
    },
    {
      id: '4',
                  ...
                  {slaPolicies.map((sla) => (
                    <Table.Tr key={sla.id}>
                      <Table.Td>
                        ...
                        <Text size="sm" c="dimmed">{sla.description}</Text>
                      </Table.Td>
                      <Table.Td>
                        <Badge color={getPriorityColor(sla.priority)} variant="light">
                          {sla.priority}
                        </Badge>
                      </Table.Td>
                      <Table.Td>
                      ...
                      <Table.Td>
                        <Badge color={sla.isActive ? 'green' : 'red'} variant="light">
                        ...
                        <Menu>
                          ...
                          <Menu.Dropdown>
                            ...
                            <Menu.Item
                              ...
                              onClick={() => router.push(`/admin/sla/${sla.id}/metrics`)}
                            >
                              View Metrics
                            </Menu.Item>
                            <Menu.Divider />
